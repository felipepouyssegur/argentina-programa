...
// crear una funcion que tome como parametro el año actual y el año de nacimiento y calcule la edad del usuario (más o menos).
...
*/
//         HECHO POR MI 10/05/2022


/*
function calcularEdadUsuario(anioActual, anioDeNacimiento) {return anioActual - anioDeNacimiento};  

const anioDeNacimiento = Number(prompt('¿En que año naciste?'));
const anioActual = Number(prompt('¿En que año estamos?'));

console.log('Tu edad es de ' + calcularEdadUsuario(anioActual, anioDeNacimiento) + ' años.')
...
function calcularSalarioMensual(salarioAnual) {return salarioAnual / 12};
...
function calcularSalarioAnual(salarioMensual) {return salarioMensual * 12};
...
function calcularSalarioSemanal(salarioMensual) {return salarioMensual / 4}; 
console.log('Tu salario semanal es de $' + calcularSalarioSemanal(salarioMensual));

        
function calcularSalarioDiario(salarioMensual) {return salarioMensual / 30}; 
console.log('Tu salario diario es de $' + calcularSalarioDiario(salarioMensual));


function calcularSalarioSemanal(salarioAnual) {const cantidadSemanasEnUnAnio = 52;return salarioAnual / cantidadSemanasEnUnAnio};
...
//pruebaHoisting(); // ESTO ES ANTI INTUITIVO PERO FUNCIONA
//function pruebaHoisting(){console.log('prueba');}

/*
ar a = 1; //VARIABLES GLOBALES (estan accesibles a todo el programa)
let b = 2; //gVARIABLES GLOBALES ("")
...
function prueba(c) { //c es un parámetro de la función prueba. LOCAL.
    ...
    if(c === 3){
        ...
        console.log('c dentro del if vale: ' + c); // lo que sea que le pasen a prueba - prueba(x)
...
/*
    ...
    const numero = 7;
    if (numero >= 7) {console.log('Nuestro número es mayor o igual que 7');} else {
...
let operador = prompt('Si usted quiere sumar ingrese +, si quiere restar ingrese -')
let numero1 = Number(prompt('Por favor, ingrese un numero.'));
let numero2 = Number(prompt('Por favor, ingrese otro numero numero.'));
...
let usuarioTieneDocumento = prompt('¿Tenes documento?').toLocaleLowerCase();
